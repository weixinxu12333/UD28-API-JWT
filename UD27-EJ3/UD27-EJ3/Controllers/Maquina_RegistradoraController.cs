...
namespace UD27_EJ3.Controllers
{
    ...
    public class Maquina_RegistradoraController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Maquina_Registradora>>> GetMaquina_Registradoras()
        {
            return await _context.Maquina_Registradoras.ToListAsync();
        }
        ...
        {
            var maquina_Registradora = await _context.Maquina_Registradoras.FindAsync(id);
        ...
        {
            _context.Maquina_Registradoras.Add(maquina_Registradora);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Maquina_Registradora>> DeleteMaquina_Registradora(int id)
        {
            ...
            _context.Maquina_Registradoras.Remove(maquina_Registradora);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Maquina_Registradoras.Any(e => e.Codigo == id);
        }
    }
}
